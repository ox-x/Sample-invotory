        ...
        getView().post(new Runnable() {
            ...
            public void run() {
                ...
                if (mContext.tagList.size() > mContext.selectIndex && mContext.selectIndex >= 0) {
                    UHFTAGInfo selectedTag = mContext.tagList.get(mContext.selectIndex);
                    String tid = selectedTag.getTid();
                    selectItem = (tid != null && !tid.isEmpty() && !tid.equals("0000000000000000") && !tid.equals("000000000000000000000000"))
                            ? tid : selectedTag.getEPC();
                }
